...
public class initialSetup {
	...
	fullhamFirst.put("CAM", lukic);
	fullhamFirst.put("CM1", reen);
	fullhamFirst.put("CM2", palhinh);
	...
	upswitchFirst.put("CAM", luongo);
	upswitchFirst.put("CM1", morsy);
	upswitchFirst.put("CM2", evens);
	...
	evertunFirst.put("CAM", iwobi);
	evertunFirst.put("CM1", onan);
	evertunFirst.put("CM2", gueye);
	...
	brightenFirst.put("CAM", gilmore);
	brightenFirst.put("CM1", caicedo);
	brightenFirst.put("CM2", macalliste);
	...
	nottinghamWoodsFirst.put("CAM", pereira);
	nottinghamWoodsFirst.put("CM1", freuler);
	nottinghamWoodsFirst.put("CM2", yates);
	...
	southamtonFirst.put("CAM", jankwitz);
	southamtonFirst.put("CM1", arreole);
	southamtonFirst.put("CM2", lavie);
	...
	bornmouthFirst.put("CAM", cooke);
	bornmouthFirst.put("CM1", ramsay);
	bornmouthFirst.put("CM2", lerme);
	...
	burntfordFirst.put("CAM", hicksy);
	burntfordFirst.put("CM1", norgaard);
	burntfordFirst.put("CM2", janelt);
	...
	wolvesFirst.put("CAM", nunes);
	wolvesFirst.put("CM1", lobato);
	wolvesFirst.put("CM2", neves);
	...
	leicestorFirst.put("CAM", dewburyHull);
	leicestorFirst.put("CM1", soumara);
	leicestorFirst.put("CM2", ndidy);
